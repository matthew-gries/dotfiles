...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
            ...
            java = {
              configuration = {
                runtimes = {
                  {
                    name = 'JavaSE-24',
                    path = vim.fn.expand '~/.sdkman/candidates/java/24-open',
                  },
                },
              },
            },
      ...
      vim.list_extend(ensure_installed, {
        ...
        'rustfmt', -- Rust formatter (usually comes with Rust)
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        css = { 'prettier' },
        scss = { 'prettier' },
        -- markdown = { 'prettier' }, -- Disabled due to markdownlint issues
        yaml = { 'prettier' },
        rust = { 'rustfmt' },
        c = { 'clang-format' },
        cpp = { 'clang-format' },
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        -- Custom keymaps to avoid macOS conflicts
  ...
  -- Terminal management
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>tg', '<cmd>lua _lazygit_toggle()<CR>', { desc = '[T]erminal [G]it (lazygit)' })
      vim.keymap.set('n', '<leader>tv', '<cmd>ToggleTerm direction=vertical size=80<CR>', { desc = '[T]erminal [V]ertical' })
      vim.keymap.set('n', '<leader>ts', '<cmd>ToggleTerm direction=horizontal size=15<CR>', { desc = '[T]erminal [S]plit' })
    end,
  },
  ...
  -- Session management
  {
    ...
    config = function()
      require('auto-session').setup {
        ...
        auto_session_create_enabled = false, -- Don't create sessions in random directories
        session_lens = {
